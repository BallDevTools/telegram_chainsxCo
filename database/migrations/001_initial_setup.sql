...
-- Created: 2024-12-19
-- Description: Initial database schema setup for Crypto Membership NFT Bot
...
CREATE INDEX IF NOT EXISTS idx_notif_log_telegram ON notification_log (telegram_id);
...
-- Cleanup old notification logs (keep only last 30 days)
